...
namespace AAXClasses
{
                                    ...
                                    private AsyncUpdater
    {
      ...
      public:
          ...
          {
              juce::Array<const float*> inputChannelList;
              ...
              const juce::AudioBuffer<float> buffer (const_cast<float**> (channels), inputChannelList.size(), *ioWindowSize);
              if (mIsFirstPass)
              {
          ...
          AAX_Result RenderAudio (const float * const inAudioIns [], int32_t inAudioInCount, float * const inAudioOuts [], int32_t inAudioOutCount, int32_t * ioWindowSize) override
          {
              ...
              auto emptyMidiBuffer = juce::MidiBuffer();

              juce::Array<const float*> inputChannelList;
              juce::Array<float*> outputChannelList;
      ...
      private:
          ...
          juce::AudioSampleBuffer getRenderAudioBuffer (juce::Array<const float*>& inputChannelList, juce::Array<float*>& outputChannelList, int32_t * ioWindowSize)
          {
    ...
    public:
        JuceAAX_Processor(AudioProcessor::WrapperType type)
            : pluginInstance (createPluginFilterOfType (type))
        {
        ...
        static AAX_CEffectParameters* AAX_CALLBACK Create()
        {
            ...
            return new JuceAAX_Processor(AudioProcessor::WrapperType::wrapperType_AAX);
        }
